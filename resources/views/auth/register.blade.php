                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="usernameInput" name="name" aria-describedby="userHelp" placeholder="ユーザ名" value="{{ old('name') }}" required>
                            <small id="emailHelp" class="form-text text-muted">英数字3～16文字（登録後の変更は出来ません）</small>
                        </div>
                        <div class="form-group">
                            <label for="emailInput">メールアドレス</label>
                            <input type="email" class="form-control" id="emailInput" name="email" aria-describedby="emailHelp" placeholder="メールアドレス" value="{{ old('email') }}" required>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block" type="submit">登録</button>
                    </form>
